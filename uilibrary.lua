...
-- Fixed: Readable Tab Text, Added Separator, Removed "by user"
-- ============================================================
local NeonFlow = {}
...
local Theme = {
    ...
    AccentGlow = {Color3.fromRGB(130, 0, 255), Color3.fromRGB(70, 0, 130)}, 
...
function NeonFlow:CreateWindow(options)
    ...
    -- Fixed: Tidak ada lagi teks "by user" kalau kosong
    ...
    local GlowStroke = Create("UIStroke", {Thickness = 3, Color = Color3.new(1,1,1), Parent = MainGlowCard}) 
    ...
    Create("UIStroke", {Color = Theme.Stroke, Thickness = 1.5, Parent = MainWindow}) 
    ...
    -- Garis Pemisah (Separator) antara Header/Tab dengan Konten
    Create("Frame", {Size = UDim2.new(1, 0, 0, 1), Position = UDim2.new(0, 0, 1, 0), BackgroundColor3 = Theme.Stroke, BorderSizePixel = 0, ZIndex = 5, Parent = TabHeaderHead})
    ...
    local TabContainer = Create("Frame", { Name = "TabContainer", Size = UDim2.new(1, 0, 1, -41), Position = UDim2.fromOffset(0, 41), BackgroundColor3 = Theme.MainBG, ClipsDescendants = true, Parent = MainWindow })
    ...
    function WindowObj:AddTab(tabOptions)
        ...
        -- Fixed: Active tab text is White, Inactive is Muted Purple
        local activeTextColor = isDefault and Theme.TextPrimary or Theme.TextMuted

        local tabTitle = Create("TextLabel", { Text = tabName, Font = Enum.Font.Gotham, TextSize = 12, TextColor3 = activeTextColor, Size = UDim2.new(1, -20, 1, -8), Position = UDim2.fromOffset(8, 4), BackgroundTransparency = 1, TextXAlignment = Enum.TextXAlignment.Left, Parent = tabBtn })
        ...
        btnTrigger.MouseButton1Click:Connect(function()
            for _, t in ipairs(self.Tabs) do 
                ...
                t.title.TextColor3 = isActive and Theme.TextPrimary or Theme.TextMuted
